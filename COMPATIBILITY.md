...
| --- | --- | --- |
| Custom Cabinet | `1.66.0`; published as `cabinet-v2026.08.24.3` / Release Bundle `v2026.08.21` | Integrated and refined source `251729c970c1ba9cc342e5b7e5938594a5b8c67c`; immutable release tag points to the same commit |
...
| Upstream Bot | `v4.1.0` / `49b05d5ab79dd9bb92f0404bb0066cda8a175649` |
| Runtime-tested Custom Cabinet commit | `251729c970c1ba9cc342e5b7e5938594a5b8c67c` |
| Candidate Cabinet artifact SHA-256 | `6e59e1d71332f01ea7f73992867ec15cfb6e7b019e7f115de3ec9ec82689b01e`; publication workflow repeated the build and verified byte identity |
...
| Runtime result | Targeted Protected Update from `v2026.08.20` to `v2026.08.21` committed on the disposable Ubuntu 24.04 VPS; exact Bot/Cabinet HEAD, three containers, Cabinet HTTP `200` and webhook default `404` passed; the full gate and Installer doctor were not rerun at the owner's request |
| Verification date | `2026-08-24` |
| Release status | `PUBLISHED AND INSTALLED ON DISPOSABLE VPS WITHOUT A REPEATED FULL GATE`: Custom Cabinet `cabinet-v2026.08.24.3` and Release Bundle `v2026.08.21` were published and installed on `2026-08-24`; the immediately preceding local checks had passed, but no new full gate or Installer doctor was run; real Telegram Android/iOS, physical screen-reader, initial Remnawave synchronization and live Remnawave `3.3.0+` GeoCheck remain outstanding; no unidentified production VPS was accessed |
