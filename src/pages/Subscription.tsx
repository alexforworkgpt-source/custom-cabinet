    ...
    >
      ...
      {isExpired ? (
        ...
        <div className="flex flex-col gap-1 sm:flex-row sm:items-baseline sm:justify-between">
          <div className="flex items-baseline gap-1 font-mono tabular-nums">
            {countdown.days > 0 && (
              <>
                ...
                <span className="mr-1 text-[10px] font-medium text-dark-500">
          ...
          <div className="text-[10px] font-medium text-dark-500">
    ...
    <div className={embedded ? 'space-y-4' : 'space-y-6'}>
      ...
      {subscription && (!embedded || hasEmbeddedSubscriptionSettings) ? (
                ...
                <div className="mb-6">
                  <div className="mb-2.5 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium text-dark-500 transition-colors hover:bg-dark-50/[0.05] hover:text-dark-400 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        <RefreshIcon
                          className="h-3 w-3"
                  ...
                  {subscription.traffic_reset_mode &&
                    subscription.traffic_reset_mode !== 'NO_RESET' && (
                      <div className="mb-2 text-[10px] text-dark-500">
                      ...
                      >
                        <div className="mb-2 flex items-center justify-between">
                          ...
                          <div className="text-right">
                            ...
                            <div className="mt-0.5 font-mono text-[9px] text-dark-500">
                        ...
                        <div className="mt-1 flex justify-between font-mono text-[9px] text-dark-500">
                          <span>
        ...
        >
          ...
          <div className="text-sm text-dark-500">{t('subscription.noSubscription')}</div>
        </div>
      ) : null}
              ...
              return (
                <div className="mt-4">
                  ...
                  {subscription.daily_price_kopeks && (
                    <div className="mt-2 text-center text-[11px] text-dark-500">
