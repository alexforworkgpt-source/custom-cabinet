...
describe('ReminderCards', () => {
  ...
  it('shows at most two localized cards', async () => {
  ...
  it('hides a card immediately and reports the dismiss', async () => {
  ...
  it('uses cabinet navigation and opens external links through the platform', async () => {
  ...
  it('refetches after returning to the tab', async () => {
    getActive.mockResolvedValue([card(1)]);
    const { client } = renderCards();
