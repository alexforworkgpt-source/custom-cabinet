      ...
      {cards.map((card) => (
        ...
        >
          <button
            ...
            onClick={() => close(card)}
            className="absolute end-3 top-3 rounded-lg p-1 text-dark-400 transition-colors hover:text-dark-100"
          >
            <XIcon />
          </button>
          <div className="pe-8 text-sm font-semibold text-dark-50">{card.title}</div>
